...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        <a class="navbar-brand" href="#">Good Health</a>
     ...
     <div class="container">
        <div class="row row-content align-items-center">
            ...
            <div  class="col col-sm col-md">
                <h2>Aedes mosquitos</h2>
                <p>Dengue fever is a mosquito-borne tropical disease caused by the dengue virus. Symptoms typically begin three to fourteen days after infection. These may include a high fever, headache, vomiting, muscle and joint pains, and a characteristic skin rash. Recovery generally takes two to seven days.</p>
            </div>
        </div>
        ...
        <div class ="row row-content align-items-center">
            ...
            <div class="col col-sm col-md">
                <h2>blockage of blood flow</h2>
                <p>A heart attack is the death of a segment of heart muscle caused by a loss of blood supply. The blood is usually cut off when an artery supplying the heart muscle is blocked by a blood clot. If some of the heart muscle dies, a person experiences chest pain and electrical instability of the heart muscle tissue. </p>
            </div>
        </div>
    </div>
    <!-- Footer -->
